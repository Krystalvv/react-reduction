  ...
  return (
    <div>
      <div style={{ padding: "20px", backgroundColor: "white" }}>
        <div style={{ margin: "5px" }}>
          ...
          <Row className="justify-content-between align-items-center" style={{ margin: "0px" }}>
            <Row className="align-items-center" style={{ margin: "0px" }}>
              {/* <Combobox items={classification} currentItem={currentItem}/> */}
              <Form>
        ...
        <SalesTableView rowData={salesData} filter='type' item={type} filter1='method' item1='플릿' />
        <Row style={{ margin: "0" }}>
          <div style={{ marginLeft: "auto" }}>{`(총${getCount('type', type, 'method', '플릿')}/${salesData.length}개)`} </div>
        </Row>
